<template>
    <div>
        <div class='jumbotron'>
            ...
            <p class="lead">to your new single-page application</p>
            <hr class="my-4"/>
            <p>This template was built with</p>
            <ul>
                <li>
                ...
                <li>
                    ...
                    <a href='http://www.typescriptlang.org/'>TypeScript</a> for client-side code using <a href="https://vuejs.org/v2/guide/single-file-components.html">Single File Components</a>
                </li>
                <li>
